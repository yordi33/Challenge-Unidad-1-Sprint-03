# gemini_client.py — llamadas a Gemini y métricas básicas
...
from config import MAX_TOKENS_INPUT, MODEL, TEMPERATURE, TEMPERATURE_RESUMEN
...
def safe_generate(prompt: str) -> tuple[str, MetricasLlamada]:
